LatticeWM is a tiling window manager inspired by i3 and built for Windows Operating Systems. The longer term goal is for it to implement all of the features that i3 has on linux.
